 ...
 *
 * <p>The Indexer consists of two Krakon X44 motors: one driving the Side Roller and one driving the
 * Straight Roller. Both rollers work in concert to transfer game pieces through the internal path.
 *
...
public interface IndexerIO {
   ...
   *
   * <p>Updated by {@link #updateInputs(IndexerIOInputs)} each control cycle.
   */
