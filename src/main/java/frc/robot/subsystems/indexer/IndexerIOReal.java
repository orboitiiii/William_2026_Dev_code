 ...
 *
 * <p>
 * This class manages CAN communication with two Krakon X44 motors:
 *
 * <ul>
 ...
 *
 * <p>
 * <strong>Control Strategy</strong>: Uses VoltageOut control for consistent
 * output regardless of
 * battery voltage fluctuations. Both motors receive the same voltage command to
 * ensure synchronized
 * operation during indexing.
 *
 * <p>
 * <strong>Motor Specifications (Krakon X44)</strong>:
 *
 * <ul>
...
public class IndexerIOReal implements IndexerIO {
    ...
    public IndexerIOReal() {
        ...
        sideConfig.MotorOutput.Inverted = Constants.Indexer.kSideRollerInverted
        ...
        straightConfig.MotorOutput.Inverted = Constants.Indexer.kStraightRollerInverted
                ? InvertedValue.Clockwise_Positive
                : InvertedValue.CounterClockwise_Positive;
        straightConfig.CurrentLimits.SupplyCurrentLimit = Constants.Indexer.kSupplyCurrentLimit;
        straightConfig.CurrentLimits.SupplyCurrentLimitEnable = Constants.Indexer.kSupplyCurrentLimitEnable;
        ...
        mAllSignals = new BaseStatusSignal[] {
                mSideRollerVelocity,
    ...
    public void setVoltage(double volts) {
        // Both motors receive the same voltage command for synchronized operation
        mSideRollerMotor.setControl(mSideRollerVoltageOut.withOutput(5.0));
        mStraightRollerMotor.setControl(mStraightRollerVoltageOut.withOutput(7.0));
    }
