...
public final class Constants {
   ...
   *
   * <p>
   * 50Hz (20ms) for subsystem control loops. High-frequency odometry (250Hz) runs
   * on a dedicated
   * thread in DriveIOReal — it does NOT go through Looper.
   */
  ...
  public static final class Swerve {
    ...
    /**
     * Safety margin applied to the theoretical friction limit in the feasibility
     * filter. Accounts
     * for CG height shift, uneven weight distribution, and mechanism inertia.
     * Effective limit =
     * kMaxDriveAcceleration * kAccelerationSafetyFactor.
     */
     ...
     */
    public static final double kMaxDriveVelocity = 3.5;
    ...
    /**
     * Hard cap on teleop angular velocity (rad/s). Applied after the ControlBoard
     * curve so the
     * curve shape is preserved at low inputs but the peak is clipped.
     */
    public static final double kMaxTeleopAngularVelocity = 2.0;
    ...
    public static final class Control {
      ...
      /**
       * Drive Motor Static Friction Feedforward Gain (kS).
       *
       * <p>
       * Units: Volts.
       *
       * <p>
       * SysId Raw Result: kS = 0.18 V
       */
       ...
       *
       * <p>
       * SysId Raw Result: kV = 2.351 V/(m/s)
       */
      public static final double kDrivekV = 2.351 * kWheelCircumference;

      /**
       * Drive Motor Acceleration Feedforward Gain (kA).
       *
       * <p>
       * Units: Voltage / (Meters/s^2).
       *
       * <p>
       * SysId Raw Result: kA = 0.047 V/(m/s^2)
       */
       ...
       * slip
       * threshold. Reduced to 70A to preserve power budget during heavy shooting.
       */
      ...
      /**
       * Steer Motor Stator Current Limit in Amps. Prevents peak current during sharp
       * turns.
       */
      public static final double kSteerStatorCurrentLimit = 60.0;

      /** Enable state for Steer Motor Stator Current Limit. */
  ...
  public static final class Intake {
    ...
    /** intake volt */
    public static final double kIntakeVoltage = 3.0; // 2.5
    ...
    /** Stator current limit in Amps. Prevents peak current during motor stall. */
  ...
  public static final class IntakePivot {
     ...
     *
     * <p>
     * Adjust this value based on actual gearbox and belt/chain reduction. Value:
     * 6.666666666666667
     */
     ...
     */
    public static final double kP = 37.0;
     ...
     *
     * <p>
     * Units: Volts. Overcomes static friction before motion begins. SysId Result
     * (2026-02-13):
     * 0.15 V
     */
     ...
     *
     * <p>
     * Units: Volts / (Rotations/sec). Compensates for back-EMF at velocity. SysId
     * Result
     ...
     *
     * <p>
     * Units: Volts / (Rotations/sec^2). Compensates for inertia during
     * acceleration. SysId
     ...
     *
     * <p>
     * Format: {Angle in Degrees, kG Coefficient}. The kG value is interpolated
     * based on angle,
     ...
     *
     * <p>
     * Units: Mechanism rotations per second. Set to 1.5 rot/s for safe operation.
     */
    /**
     * Cruise velocity for Motion Magic (UP Direction).
     *
     * <p>
     * Units: Mechanism rotations per second. Fast up (8.0 rot/s).
     */
     ...
     *
     * <p>
     * Units: Mechanism rotations per second squared. Fast up (8.0 rot/s^2).
     */
     ...
     *
     * <p>
     * Units: Mechanism rotations per second. Now matched to fast UP speed.
     */
     ...
     *
     * <p>
     * Units: Mechanism rotations per second squared. Now matched to fast UP accel.
     */
    public static final double kAccelerationDown = 5.0;
    ...
    /**
     * Extra downward voltage applied when the pivot is deployed and wheels are
     * intaking.
     *
     * <p>
     * Used to ensure the intake firmly presses against the floor/bumpers to pick up
     * game pieces.
     * Positive voltage moves the pivot UP, so this value is subtracted from the
     * output.
     */
    public static final double kIntakeDownPressureVolts = 0.75;
  }
   ...
   *
   * <p>
   * Defines motor configuration and control parameters for the Kraken X44 motor
   * with a 1:125
   * gear ratio pulling the climb string.
   */
  public static final class Climb {
    /** CAN ID for the climb motor (Kraken X44). */
    public static final int kMotorId = 60;

    /** Gear ratio from motor rotation to mechanism output (spool). */
    public static final double kGearRatio = 108.0;
    ...
    /**
     * Stator current limit in Amps. Limits motor torque output to avoid breaking
     * the string.
     */
    ...
    // --- PID Control Gains ---
    /** Proportional gain for position control. (Units: Volts / Rotation) */
    ...
    /** Velocity feedforward. (Units: Volts / (Rotations/sec)) */
    public static final double kV = 0.0;

    /** Static friction feedforward. (Units: Volts) */
    public static final double kS = 0.0;

    /** Acceleration feedforward. (Units: Volts / (Rotations/sec^2)) */
  ...
  public static final class Indexer {
    ...
    // --- Motor Parameters ---
    /**
     * Gear ratio from motor to the mechanism output. Value > 1.0 means reduction
     * (motor spins
     * faster than output).
     */
    public static final double kSideRollerGearRatio = 4.0;
     ...
     */
    @Deprecated
    public static final double kStraightRollerVoltage = -2.0;

    // --- Velocity Control ---
    public static final double kSideRollerTargetVelocity = -40.0;
    public static final double kStraightRollerTargetVelocity = -20.0;

    // --- Side Roller Gains (SysId Result: 2026-03-01) ---
    /**
     * Static friction voltage (kS).
     *
     * <p>
     * Units: Volts. Overcomes static friction before motion begins. Derived from
     * SysId (OLS
     * Regression).
     */
    public static final double kSidekS = 0.05758;

    /**
     * Velocity feedforward gain (kV).
     *
     * <p>
     * Units: Volts / (Mechanism Rotations/sec). Compensates for back-EMF at
     * velocity. SysId was
     * run with SensorToMechanismRatio applied, so this is used directly.
     */
    public static final double kSidekV = 0.45860;

    /**
     * Acceleration feedforward gain (kA).
     *
     * <p>
     * Units: Volts / (Mechanism Rotations/sec^2). Compensates for inertia during
     * acceleration.
     */
    public static final double kSidekA = 0.01702;

    /**
     * Proportional gain for velocity control (kP).
     *
     * <p>
     * Units: Volts / (Mechanism Rotations/sec error). Calculated for a very
     * aggressive
     * closed-loop time constant (tau) of 0.02s.
     */
    public static final double kSidekP = 0.3926;

    // --- Straight Roller Gains (SysId Result: 2026-03-01) ---
    /**
     * Static friction voltage (kS).
     *
     * <p>
     * Units: Volts. High value indicates significant mechanical stiffness dragging
     * the straight
     * path. Absolute value derived from SysId.
     */
    public static final double kStraightkS = 2.40724;

    /**
     * Velocity feedforward gain (kV).
     *
     * <p>
     * Units: Volts / (Mechanism Rotations/sec).
     */
    public static final double kStraightkV = 0.16172;

    /**
     * Acceleration feedforward gain (kA).
     *
     * <p>
     * Units: Volts / (Mechanism Rotations/sec^2). Negligible measured inertia.
     */
    public static final double kStraightkA = 0.00037;

    /**
     * Proportional gain for velocity control (kP).
     *
     * <p>
     * Units: Volts / (Mechanism Rotations/sec error). Very conservative (0.0),
     * relying entirely
     * on FF since kA is effectively zero.
     */
    ...
    /**
     * Stator current limit in Amps per motor. Prevents peak current during game
     * piece handling.
     */
    public static final double kStatorCurrentLimit = 50.0;
  ...
  public static final class Shooter {
     ...
     *
     * <p>
     * SysId Result (2026-02-15): 0.20460 V
     */
     ...
     *
     * <p>
     * Units: Volts / (rotations per second). SysId Result (2026-02-15): 0.11442
     * V/(rot/s)
     */
     ...
     *
     * <p>
     * Units: Volts / (rotations per second squared). SysId Result (2026-02-15):
     * 0.01998
     * V/(rot/s^2)
     */
   ...
   *
   * <p>
   * The turret is a continuous rotation mechanism with ±210° range, driven by a
   * single KrakenX60
  ...
  public static final class Turret {
    ...
    /**
     * Number of teeth on the auxiliary gear (meshes directly with 340T turret ring,
     * used for CRT
     * positioning).
     */
     ...
     *
     * <p>
     * Calibration: Rotate turret to zero (facing robot forward), read raw CANcoder
     * value,
     * negated value is the offset.
     */
    public static final double kMotorEncoderOffsetRotations = -0.242431640625;
     ...
     */
    public static final double kAuxEncoderOffsetRotations = -0.36669921875;

    /**
     * SensorToMechanismRatio: Motor Rotations / Turret Rotations.
     *
     * <p>
     * Gear Ratio = 1:4 reduction from motor to 19T gear, then 19T meshes with 87T
     * Turret ring.
     * So motor rotates 4 * (87 / 19) times for 1 turret rotation.
     */
    public static final double kGearRatio = 4.0 * ((double) kTurretRingTeeth / kMotorGearTeeth);

    // --- Angle Limits ---

    /** Minimum turret angle in radians (CCW limit). */
    public static final double kMinAngleRads = Math.toRadians(-270);

    /** Maximum turret angle in radians (CW limit). */
    public static final double kMaxAngleRads = Math.toRadians(90);

    /**
     * Overlap margin for tracking mode.
     *
     * <p>
     * <strong>Physics Note</strong>: When tracking a target while the robot
     * rotates, the turret
     * needs to temporarily exceed the ±180° range to maintain continuous tracking
     * without reversing
     * direction.
     */
    public static final double kTrackOverlapMarginRads = Math.toRadians(5.0);

    // --- PID Gains ---
    public static final double kP = 120.0;

    /** Integral gain for position control. */
    public static final double kI = 80.0;

    /** Derivative gain for position control. */
    public static final double kD = 0.80;
    ...
    /** Total System Latency compensation in seconds (Pose Prediction). */
    public static final double kLookaheadSeconds = 0.040;
    ...
    /** Position tolerance for entering "at goal" state in radians (2.0°). */
    public static final double kPositionToleranceRadsEnter = Math.toRadians(2.0);

    /**
     * Position tolerance for exiting "at goal" state in radians (5.0°). Hard upper
     * bound.
     */
    public static final double kPositionToleranceRadsExit = Math.toRadians(5.0);

    /**
     * Hub apothem (inscribed circle radius) in meters. Regular hexagon
     * vertex-to-vertex = 41.73 in;
     * apothem = D/2 * cos(30°). Used to compute distance-dependent turret exit
     * tolerance so the
     * ball always lands inside the Hub opening.
     */
    public static final double kHubApothemMeters = edu.wpi.first.math.util.Units.inchesToMeters(41.73) / 2.0
        * Math.cos(Math.toRadians(30));

    /**
     * Turret angular velocity tolerance for "at goal" (rad/s). If the turret is
     * slewing faster than
     * this, the ball will miss during its time-of-flight even if the position error
     * is momentarily
     * small.
     */
   ...
   *
   * <p>
   * The hood is a limited-travel mechanism that adjusts the projectile launch
   * angle. Higher
  ...
  public static final class Hood {
     ...
     *
     * <p>
     * Motor rotations * kGearRatio = Hood rotations.
     */
    /**
     * Gearbox reduction (Input / Output).
     *
     * <p>
     * 1:5 Planetary Gearbox.
     */
     ...
     *
     * <p>
     * Formula: $$\Delta \theta_{load} = \frac{\Delta R_{motor}}{G_{box}} \times
     * \frac{N_{pinion}}{N_{sector\_virtual}} \times 360^\circ$$
     *
     * <p>
     * Phoenix 6 SensorToMechanismRatio (Sensor Rotations / Mechanism Rotations):
     * Ratio = G_box *
     ...
     *
     * <p>
     * Physical Zero Reference: When motor encoder reads 0 rotations, hood is at
     * 65°.
     */
     ...
     *
     * <p>
     * Corresponds to motor position = 0.
     */
     ...
     *
     * <p>
     * TODO: Measure the actual minimum angle based on mechanical travel limit.
     */
     ...
     *
     * <p>
     * SysId Result: Average of forward (0.3759V) and reverse (0.4497V) quasistatic
     * tests.
     */
     ...
     *
     * <p>
     * SysId Result: Average of forward (4.6979) and reverse (4.2875) quasistatic
     * tests.
     *
     * <p>
     * Units: Volts / (mechanism rotations per second).
     */
     ...
     *
     * <p>
     * SysId Result: ~0.0366 (very small due to 42.5:1 reduction).
     */
     ...
     *
     * <p>
     * Units: Volts. Compensates for gravity torque at horizontal position. Uses
     * Arm_Cosine mode:
     * kG * cos(position_in_rotations * 2π). Calculated from SysId Quasistatic tests
     * at different
     * angles.
     */
     ...
     *
     * <p>
     * Units: Volts / (Meters/sec^2).
     *
     * <p>
     * Compensates for inertial forces on the hood when the robot accelerates.
     *
     * <p>
     * Formula: FF_acc = kARobot * Accel_Robot * sin(HoodAngle)
     */
     ...
     *
     * <p>
     * At kV=4.49, 0.5 rot/s uses ~2.7V (safe under 5V limit).
     */
     ...
     *
     * <p>
     * Smooth ramp-up/ramp-down for large angle changes.
     */
     ...
     *
     * <p>
     * If |target - current| >= this threshold, use MotionMagic. Otherwise, use PD +
     * FF.
     */
    ...
    /** Position tolerance for entering "at goal" state in radians (0.50 deg). */
    public static final double kPositionToleranceRadsEnter = Math.toRadians(0.50);

    /** Position tolerance for exiting "at goal" state in radians (1.5 deg). */
    public static final double kPositionToleranceRadsExit = Math.toRadians(1.5);

    /**
     * Velocity deadband (rad/s) — below this, velocity feedforward is treated as
     * zero.
     */
    public static final double kVelocityDeadbandRadPerSec = 0.05;
  }
   ...
   *
   * <p>
   * These parameters control the physics-based shooting compensation algorithm
   * that enables
   * accurate target acquisition while the robot is moving.
   *
   * <p>
   * <strong>Reference</strong>: Based on Team 6328's 2024 ShotCalculator
   * architecture.
   */
  public static final class Shot {
     ...
     *
     * <p>
     * <strong>Coordinate Frame</strong>: Robot-relative (+X forward, +Y left).
     *
     * <p>
     * <strong>Measurement</strong>: Measure from the geometric center of the robot
     * (midpoint of
     * drivetrain) to the turret azimuth rotation axis.
     *
     * <p>
     * TODO: Update this value based on CAD measurements.
     */
    public static final Translation2d kRobotToTurret = new Translation2d(0.2302, 0.1552);

    /**
     * Height of the shooter exit point from the floor.
     *
     * <p>
     * Used in 3D slant range / collision cross-section shrinkage calculations.
     */
    public static final double kShooterHeightMeters = 0.48;

    /**
     * Control loop phase delay compensation in seconds.
     *
     * <p>
     * <strong>Physics Note</strong>: The robot's pose estimate lags reality due to
     * sensor
     * latency and processing time. This value advances the pose estimate by the
     * expected delay to
     * improve aiming accuracy.
     *
     * <p>
     * Typical value: 30-50ms for CAN + odometry latency.
     */
     ...
     *
     * <p>
     * <strong>Constraint</strong>: Below this distance, the ballistic solver cannot
     * find a valid
     ...
     *
     * <p>
     * <strong>Constraint</strong>: Beyond this distance, projectile energy at max
     * RPM is
     ...
     *
     * <p>
     * <strong>Signal Processing</strong>: This moving average filter smooths out
     * high-frequency
     * noise in the turret/hood velocity calculations.
     */
     ...
     *
     * <p>
     * Due to aerodynamic drag during the instant the ball leaves the shooter, it
     * does not
     * inherit 100% of the robot's velocity. Tune this down if high-speed shooting
     * overcompensates
     * (overshoots less or undershoots). 1.0 = Perfect vacuum physics. 0.5 = 50%
     * retained.
     */
     ...
     *
     * <p>
     * <strong>Convergence</strong>: The iterative ToF solver typically converges
     * within 5-10
     * iterations. Additional iterations provide diminishing returns and add
     * computational cost.
     */
